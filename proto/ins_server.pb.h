...
// source: ins_server.proto

#ifndef PROTOBUF_ins_5fserver_2eproto__INCLUDED
#define PROTOBUF_ins_5fserver_2eproto__INCLUDED
...
class Entry : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_ins_5fserver_2eproto();
  friend void protobuf_AssignDesc_ins_5fserver_2eproto();
  friend void protobuf_ShutdownFile_ins_5fserver_2eproto();
...
class InsServer_Stub;

class InsServer : public ::google::protobuf::Service {
 protected:
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(InsServer);
};

class InsServer_Stub : public InsServer {
 public:
  InsServer_Stub(::google::protobuf::RpcChannel* channel);
  InsServer_Stub(::google::protobuf::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(InsServer_Stub);
};
...
#endif  // PROTOBUF_ins_5fserver_2eproto__INCLUDED
